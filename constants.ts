import { UserProfile, Subject, Exercise, Flashcard, LeaderboardUser, PastExam, CommunityPost, CommunityAnswer } from './types';

export const mockUser: UserProfile = {
  // FIX: Added missing 'id' property to conform to UserProfile type.
  id: 'user-me',
  name: 'عادل',
  avatarUrl: 'https://i.imgur.com/E5J0f7L.jpeg',
  points: 1250,
  streak: 5,
  badges: [
    ...
    lessons: [
      {
        ...
        pdfUrl: '#',
        quiz: [
            { question: 'ما هو ناتج (2 + 3i) + (4 - i)؟', options: ['6 + 2i', '6 + 4i', '2 - 2i'], correctAnswer: '6 + 2i' },
            { question: 'ما هو الجزء التخيلي للعدد 5 - 7i؟', options: ['5', '-7', '7'], correctAnswer: '-7' }
        ]
      },
      {
        id: 'math-l2',
...
export const mockDailyChallenge: Exercise[] = [
    { id: 'ex1', subject: 'الرياضيات', type: 'mcq', question: 'ما هو حل المعادلة x² + 1 = 0 في مجموعة الأعداد المركبة؟', options: ['x=1', 'x=-1', 'x=i و x=-i'], correctAnswer: 'x=i و x=-i' },
    { id: 'ex2', subject: 'الفيزياء', type: 'true-false', question: 'وحدة قياس القوة هي الواط.', correctAnswer: 'False' },
    { id: 'ex3', subject: 'العلوم', type: 'mcq', question: 'أين تتم عملية الاستنساخ في الخلية حقيقية النواة؟', options: ['الهيولى', 'النواة', 'الريبوزوم'], correctAnswer: 'النواة' },
    { id: 'ex4', subject: 'الرياضيات', type: 'true-false', question: 'الدالة f(x) = e^x هي دالة متناقصة تماماً.', correctAnswer: 'False'},
    { id: 'ex5', subject: 'الفيزياء', type: 'mcq', question: 'أي من هذه الظواهر تتعلق بالميكانيك الكمي؟', options: ['قانون الجذب العام', 'ازدواجية موجة-جسيم', 'قانون أوم'], correctAnswer: 'ازدواجية موجة-جسيم'}
];
